...
PROMPT = ChatPromptTemplate.from_messages([
    ("system", (
        ...
        "## Specific Moment\n"
        "In Act III, Scene III, Hamlet finds Claudius alone and praying — a perfect opportunity to strike. "
        "Yet he holds back, reasoning that killing Claudius mid-prayer would send him to heaven.\n\n"
        "## Quote Specifically\n"
        "\"Now might I do it pat, now he is praying; And now I'll do't. And so he goes to heaven; "
        "And so am I revenged. That would be scanned\" (Act III, Scene III)\n\n"
        "## Analyse the Moment\n"
        "This reveals Hamlet's tendency to over-intellectualise action. His moral scrupulousness becomes "
        "the very instrument of his failure, deepening the play's tragedy.\n\n"
        "Now answer the following question using the same four sections."
    )),
